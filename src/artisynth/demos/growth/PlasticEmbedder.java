...
public class PlasticEmbedder {
    ...
    * configuration simply mirrors the world configuration. This is particularly
    * useful if you want to simulate growth/plasticity without any elasticity.
    */
   ...
   protected boolean hasBackNode () {
      if (this.mHasBackNodes == null) {
         this.mHasBackNodes =
            (mFemModel.numShellElements () > 0 && mFemModel
