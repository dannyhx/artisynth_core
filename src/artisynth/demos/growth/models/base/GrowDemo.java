 ...
 * 
 * -disableHybridSolves -numSolverThreads 1
 * 
 * DEV NOTES: - Polarity direction is set explicitly before each growth step.
 * 
 * - ContinuousCollider.myUnilaterals = masterCC; is now in effect in
 * MechSystemSolver.java Remesh will now actually interpolate the unilaterals.
 * 
...
public class GrowDemo extends ShellPatch {
   ...
   /**
    * Weighing for the curvature metrics. Higher weight -> less refinement at
    * curved areas.
    */
   protected static double mRefineAngle = 0.2;

   /**
    * Weighing for the strain metrics. Higher weight -> less refinement at
    * strained areas.
    */
   protected static double mRefineCompression = 0.01;

   /**
    * Weighing for the velocity metrics. Higher weight -> less refinement at
    * moving areas.
    */
   ...
   /**
    * Chemicals that are associated with the nodes. Each array index corresponds
    * to a particular model.
    */
   protected MeshChemicals[] mMeshChems;

   /**
    * Number of different morphogen types. (PAR, PER, NOR, DF). DF is a special
    * diffusible morphogen that is essentially converted into PAR and PER when
    * absorbed, allowing us to perform a single diffusion simulation for both
    * PAR and PER.
    */
   protected int mNumChemTypes = 4;

   /**
    * Fraction of morphogen (DF) converted into its activated form (PAR, PER)
    * per timestep.
    */
   ...
   /**
    * Where should the reference mesh should be placed, relative to the model in
    * world-space.
    */
   ...
   /**
    * Collision settings between each pair of models, including self collisions.
    */
   ...
   /**
    * When a incision occurs at a node (which is replaced with two nodes), much
    * should the two nodes be pushed apart?
    */
    ...
    * 
    * DEFAULT :: Edges and vertices shown. MORPHOLOGY :: Smooth with no visible
    * discretization. TOPOLOGY :: Edges shown with no shaders.
    */
   protected enum RenderMode {
      DEFAULT, MORPHOLOGY, TOPOLOGY
   }
   ...
   public enum SurfaceColor {
      DEFAULT, PLASTIC_STRAIN, MORPHOGEN, RESIDUAL_PLASTIC_BENDING_STRAIN
   }
   ...
   /**
    * When toggled to true, currently selected nodes are incised. Resets back to
    * false after incision.
    */
   ...
   protected void build_utils () {
      ...
      for (int m = 0; m < M; m++) {
         ...
         mMeshChems[m] =
            new MeshChemicals (mFemModel[m].numNodes (), mNumChemTypes);
      ...
      mDiffusion =
         new Diffusion (
            mMesh[0], mMeshChems[0], new int[] { mChemTypeToDiffuse });
      mMorphogen2GrowthTensor =
         new Morphogen2GrowthTensor ((GrowModel3d)mFemModel[0], mMesh[0]);
      mRemesher =
         new GrowRemesher (
            mMesh[0], mFemModel[0], mSizeMin, mSizeMax, mAspectMin,
            mRefineAngle, mRefineCompression, mRefineVelocity, mRefineMorphogen,
            mMeshChems[0]);
      mGrowColorer =
         new GrowColorer (this, (GrowModel3d)mFemModel[0], mShowColorBar);
   ...
   protected GrowNode3d createNode (Point3d pt) {
      return new GrowNode3d (
         pt, new VectorNd (mNumChemTypes), mEleClass == ElementClass.SHELL);
   }
   ...
   protected FemElement3d createVolElement (
      ...
      return new GrowWedgeElement (
         (GrowNode3d)n0, (GrowNode3d)n1, (GrowNode3d)n2, (GrowNode3d)n3,
         (GrowNode3d)n4, (GrowNode3d)n5);
   }

   protected GrowTriElement createShellElement (
      FemNode3d n0, FemNode3d n1, FemNode3d n2, double thickness) {
      return new GrowTriElement (
         (GrowNode3d)n0, (GrowNode3d)n1, (GrowNode3d)n2, thickness,
   ...
   static {
      ...
      myProps
         .add (
            "maxPlasticStrainColorBarRange", "", mMaxPlasticStrainColorBarRange,
            "[1,2]");
   ...
   public boolean getEnableDiffusion () {
      return mEnableDiffusion;
   }

   public void setEnableDiffusion (boolean val) {
      mEnableDiffusion = val;
   }

   public boolean getEnableGrowth () {
      return mEnableGrowth;
   }

   public void setEnableGrowth (boolean val) {
      mEnableGrowth = val;
   }

   public boolean getEnableRemesh () {
      return mEnableRemesh;
   }

   public void setEnableRemesh (boolean val) {
      mEnableRemesh = val;
   }

   public boolean getEnablePlasticEmbedding () {
      return mEnablePlasticEmbedding;
   }

   public void setEnablePlasticEmbedding (boolean val) {
      mEnablePlasticEmbedding = val;
   }

   public boolean getEnableCollisionHandling () {
      return mEnableCollisionHandling;
   }

   public void setEnableCollisionHandling (boolean val) {
      mEnableCollisionHandling = val;
   }

   public boolean getEnableSelfCollision () {
      return mEnableSelfCollision;
   }

   public void setEnableSelfCollision (boolean val) {
      mEnableSelfCollision = val;
   }

   public boolean getMaintainResidualStrain () {
      return mMaintainResidualStrain;
   }

   public void setMaintainResidualStrain (boolean val) {
      mMaintainResidualStrain = val;
   }

   public double getMinEnergyBeforePausing () {
      return mMinEnergyBeforePausing;
   }

   public void setMinEnergyBeforePausing (double val) {
      mMinEnergyBeforePausing = val;
   }
   ...
   public void setNodeColor (NodeColor val) {
      mNodeColor = val;
   }
   ...
   public void setSurfaceColor (SurfaceColor val) {
      mSurfaceColor = val;
   }

   public double getSF_refineAngle () {
      return mRefineAngle;
   }

   public void setSF_refineAngle (double val) {
      mRefineAngle = val;
   }

   public double getSF_refineCompression () {
      return mRefineCompression;
   }

   public void setSF_refineCompression (double val) {
      mRefineCompression = val;
   }

   public double getSF_refineVelocity () {
      return mRefineVelocity;
   }

   public void setSF_refineVelocity (double val) {
      mRefineVelocity = val;
   }

   public double getSF_sizeMin () {
      return mSizeMin;
   }

   public void setSF_sizeMin (double val) {
      mSizeMin = val;
   }

   public double getSF_sizeMax () {
      return mSizeMax;
   }

   public void setSF_sizeMax (double val) {
      mSizeMax = val;
   }

   public double getSF_aspectMin () {
      return mAspectMin;
   }
   ...
   public double getMaxPlasticStrainColorBarRange () {
      return mMaxPlasticStrainColorBarRange;
   }

   public void setMaxPlasticStrainColorBarRange (double val) {
      mMaxPlasticStrainColorBarRange = val;
      mGrowColorer.mMaxPlasticStrainColorBarRange =
         mMaxPlasticStrainColorBarRange;
   }

   public boolean getCutSelectedNodes () {
      return mCutSelectedNodes;
   }
   ...
   public void setResetCamera (boolean val) {
      ...
      if (Main.getMain ().getViewer () != null) {
         Main
            .getMain ().getViewer ()
            .setBackgroundColor (mRendCfg.mBackgroundColor);
      }
   ...
   public double getCustomDouble () {
      return this.mGrowColorer.mMaxResidualPlasticStrainColorBarRange;
   }

   public void setCustomDouble (double val) {
      this.mGrowColorer.mMaxResidualPlasticStrainColorBarRange = val;
   }
   ...
   public void advanceCustom (double t0, double t1, int flags) {
      ...
      && mNumRemeshRemaining > 0 && t0 > 0.01) {
         ...
         System.out
            .printf (
               "Remesh occurred. Eles: %d, Nodes: %d \n",
      ...
      System.out
         .println (
            "Time step solve (ms): " + (mCurElapsedTime - mPrvElapsedTime));
   ...
   protected void updateNodesColor () {
      for (int m = 0; m < M; m++) {
         for (FemNode3d node : mFemModel[m].getNodes ()) {
            ...
            RenderProps
               .setPointColor (node, Color.getHSBColor (1.f, amtPct, 1.f));
         }
      }
   }
   ...
   protected double convertAmtToColorSaturation (double amt) {
      double max = 1;
      return (amt > max) ? 1 : (amt < 0) ? 0 : amt / max;
   }
   ...
   protected void toggleCollisionBehavior (boolean isEnable) {
      ...
      CollisionDetector.myEnableContinuousDetection =
         mEnableContinuousDetection;
      CollisionDetector.myEnableImpactZoneDetection =
         mEnableImpactZoneDetection;
   ...
   protected void inciseSelectedNodes () {
      ...
      for (ModelComponent comp : Main
         .getMain ().getSelectionManager ().getCurrentSelection ()) {
      ...
      FemModel3d femModel =
         (FemModel3d)selectedNodes.get (0).getParent ().getParent ();
