...
public class StVKMaterial extends DiscreteShellMaterial {
    ...
    * 
    * Called by DiscreteShell.elasticEnergy(). Verified.
    * 
    * @param ele
    * @param rs
    * @param f
   ...
   public double stretchingEnergy (
      ...
      Matrix2d a =
         GeometryDerivative
            .firstFundamentalForm (
               MC, model, f, (derivative != null) ? aderiv : null,
      ...
      MM.mul (M, M);
      double StVK =
         0.5 * lameAlpha_ * pow (M.trace (), 2) + lameBeta_ * MM.trace ();
    ...
    * [18+3*numExtraDOFs]
    * @param hessian
    * [18+3*numExtraDOFs, 18+3*numExtraDOFs]
    */
   public double bendingEnergy (
      ...
      Matrix2d b =
         MidedgeAngleTanFormulation
            .secondFundamentalForm (
               model, extraDOFs, MC, face, (derivative != null) ? bderiv : null,
      ...
      // StVk norm (||M||SV)
      double StVK =
         0.5 * this.lameAlpha_ * pow (M.trace (), 2)
         ...
         for (int i = 0; i < 4; i++) {
            ...
            hessian
               .scaledAdd (
                  ...
                  + 2 * lameBeta_ * Mainv.get (i / 2, i % 2), bhess[i]);
         }
