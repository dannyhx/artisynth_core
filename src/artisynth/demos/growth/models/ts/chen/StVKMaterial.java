...
public class StVKMaterial extends DiscreteShellMaterial {
   ...
   public StretchingEnergyRv stretchingEnergy(ShellElement3d ele, RestState rs, int f) {
      ...
      MatrixNd aderiv = ffrv.Derivative;
      MatrixNd[] ahess = ffrv.Hessian;
      ...
      MatrixNd temp_4x1 = MatrixUtil.m2x2_to_mat4x1_colMaj (temp);
      MatrixNd derivative = new MatrixNd(9, 1);
      derivative.mulTransposeLeft (aderiv, temp_4x1);
      derivative.scale (coeff * dA);

      // Hessian
      
      MatrixNd hessian = new MatrixNd(9,9);
      ...
      Vector4d abarinv_vec = MatrixUtil.m2x2_to_vec4_colMaj (abarinv);
      Vector4d Mainv_vec = MatrixUtil.m2x2_to_vec4_colMaj (Mainv);
