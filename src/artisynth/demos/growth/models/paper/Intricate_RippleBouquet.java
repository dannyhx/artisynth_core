...
public class Intricate_RippleBouquet extends GrowDemo {
      ...
      for (int i = 0; i < numRings; i++) {
         for (int a = 0; a < numSubLayers; a++) {
            ...
            PolygonalMesh layer =
               MeshFactory
                  .createOctadecahedralSphere (
                     radBase + (radRef) * (i), resolBase + i); // radBase*(3+1.5*i)
                                                               // ,
                                                               // resolBase+i+1
            ...
            if (baseBotPnt == null) {
               ...
               Vector3d toBaseBotPnt =
                  new Vector3d (baseBotPnt).sub (curBotPnt);
               X.setIdentity ();
            ...
            _Exp_Toolbox
               .trimStrip (
                  layer, Point2d.ZERO,
                  (Point2d)(new Point2d (-1.448, 2.509).scale (10)), stripRad,
                  minZ);
            ...
            _Exp_Toolbox
               .trimStrip (
                  layer, Point2d.ZERO, (Point2d)(new Point2d (3, 0).scale (10)),
                  stripRad, minZ);
   ...
   protected void build_femRendering () {
      ...
      Color[] frontColors =
         new Color[] { new Color (255, 0, 102), new Color (255, 204, 204),
                       new Color (255, 51, 153), new Color (204, 153, 153),
                       new Color (255, 51, 51), };

      Color[] backColors =
         new Color[] { new Color (255, 127, 179), new Color (255, 229, 229),
                       new Color (255, 153, 204), new Color (229, 204, 204),
