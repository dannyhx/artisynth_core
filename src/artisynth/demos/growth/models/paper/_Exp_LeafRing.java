...
public class _Exp_LeafRing extends GrowDemo {
   ...
   protected void build_modelSkeleton () {
      ...
      for (int m = 0; m < M; m++) {
         ...
         // MeshToolbox.trimVertically (mMesh[m], Double.NEGATIVE_INFINITY,
         // 0.17);
      }
   }
   ...
   protected Face equilateralTriangle (double sideLen) {
      ...
      // Top
      Vertex3d vtx2 =
         new Vertex3d (sideLen / 2, sin (toRadians (60)) * sideLen, 0);
   ...
   protected void build_femRendering () {
      ...
      Color[] frontColors =
         new Color[] { new Color (127, 255, 127), new Color (255, 229, 203),
                       new Color (140, 255, 101), new Color (178, 255, 127),

                       // new Color(101,255,255),
                       new Color (204, 204, 255),

                       new Color (255, 178, 178), new Color (255, 255, 127),
                       new Color (101, 255, 140), };

      Color[] backColors =
         new Color[] { new Color (0, 255, 0), new Color (255, 204, 153),
                       new Color (51, 204, 0), new Color (102, 255, 0),

                       new Color (0, 153, 153), new Color (255, 102, 102),
                       new Color (255, 255, 0), new Color (0, 204, 51) };
      ...
      RenderProps
         .setPointStyle (mFemModel[m].getNodes (), Renderer.PointStyle.SPHERE);
      RenderProps
