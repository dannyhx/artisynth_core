...
public class GrowIntegrationData3d extends IntegrationData3d {
   ...
   /**
    * Plastic deformation gradient. For linear material, this is `I + plastic
    * strain`.
    */
    ...
    * 
    * By default, it is null or an identity matrix, indicating that no plastic
    * strain is present.
    */
    ...
    * 
    * By default, preF is null or an identity matrix, indicating that no plastic
    * strain is present.
    */
    ...
    * 
    * The negative sign in -0.5 is intended, which will cause the model to
    * believe that is it "shrunk" and should expand to retrieve the strain.
    */
