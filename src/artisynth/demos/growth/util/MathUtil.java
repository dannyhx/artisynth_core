...
public class MathUtil {
   ...
   public static void outerProduct (
      double[] a, double[] b, DenseMatrixBase mtx) {
   ...
   public static Point2d getClosestPtToLineSegment2d (
      ...
      Point2d C = new Point2d (A.x + BA.x * t, A.y + BA.y * t);
   ...
   public static void mul (
      DenseMatrixBase A, DenseMatrixBase B, DenseMatrixBase rv) {
      int m = A.rowSize ();
      int n = A.colSize ();
   ...
   public static MatrixNd perp2x2 (DenseMatrixBase a) {
      ...
      rv
         .set (
            new double[] { a.get (1, 1), -a.get (0, 1), -a.get (1, 0),
                           a.get (0, 0) });
      return rv;
   }
   ...
   public static Point3d centroid (Face face) {
      return MathUtil
         .centroid (face.getPoint (0), face.getPoint (1), face.getPoint (2));
   }
   ...
   public static double doubleDotProduct (
      SymmetricMatrix3d a, SymmetricMatrix3d b) {
      double sum = 0;
      for (int i = 0; i < 3; i++) {
         for (int j = 0; j < 3; j++) {
   ...
   public static Matrix3d outerProduct (Vector3d a, Vector3d b) {
      return new Matrix3d (
         a.x * b.x, a.x * b.y, a.x * b.z, a.y * b.x, a.y * b.y, a.y * b.z,
    ...
    * Head
    */
   public static double distanceBetweenPointAndLine (
      Point3d x, Point3d a, Point3d b) {
   ...
   public static Vector3d triangleGradient (Point3d[] pnts, double[] xs) {
      ...
      double d22 = v20.dot (v20);

      double x10 = xs[1] - xs[0];
      double x20 = xs[2] - xs[0];
      ...
      g.scaledAdd (ab.x, v10);
      g.scaledAdd (ab.y, v20);
   ...
   /**
    * Given a triangle in 3D space and a 3D vector that's along the plane of the
    * triangle, return the vector in tangent coordinates (x,y).
    * 
   ...
   public static Vector3d linearInterpolation (
      Vector3d A, Vector3d B, double bScale) {
   ...
   public static Vector3d linearInterpolation (
      Vector3d A, Vector3d B, Vector3d C, double aScale, double bScale) {
   ...
   public static Point3d linearInterpolation (
      Point3d A, Point3d B, Point3d C, double aScale, double bScale) {
