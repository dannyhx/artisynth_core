 ...
 * 
 * FemDeformPoint is basically a utility that operates on its given integration
 * point, such as computing the deformation gradient.
 */
public class GrowDeformedPoint extends FemDeformedPoint {

   public void setFromIntegrationPoint (
      IntegrationPoint3d ipnt, IntegrationData3d idat, RotationMatrix3d R,
