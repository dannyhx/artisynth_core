...
public class SweptEdge extends BoundablePointArray {
   ...
   public boolean isSweepIdle (double elipson) {
      return (myPnts[H1].distance (myPnts[H0]) < elipson
    ...
    * 
    * @return Instanteous edge in vector form.
    */
    ...
    * edge that's half-way along its traversed path.
    * 
    * @return Head and tail vertex locations of the instanteous edge.
    */
    ...
    */
   public double computeClosestEdgePairPoints (
      SweptEdge se1, double t, Point3d out_e0, Point3d out_e1, Vector2d rs,
      double epsilon) {
   ...
   public static void main (String[] args) {
      ...
      SweptEdge se0 =
         new SweptEdge (
            he0,
            new Point3d[] { new Point3d (0, 1, 0), new Point3d (0, 0, 0) });
      ...
      SweptEdge se1 =
         new SweptEdge (
            he1,
            new Point3d[] { new Point3d (0, 0, 1), new Point3d (0, 0, 0.3) });

      Point3d cp0 = new Point3d ();
      Point3d cp1 = new Point3d ();
      double minDist =
         se0.computeClosestEdgePairPoints (se1, 1, cp0, cp1, null, 1e-6);

      System.out
         .printf (
            "MinDist: %.4f, CP0: %s, CP1: %s", minDist, cp0.toString ("%.2f"),
            cp1.toString ("%.2f"));
