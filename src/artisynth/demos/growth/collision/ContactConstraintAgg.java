...
public class ContactConstraintAgg {
   ...
   /**
    * Collision handler for each collidable body pair. Each handler has its own
    * set of unilateral constraints.
    */
   ...
   public ContactConstraintAgg (ArrayList<CollisionHandler> colHdlrs,
   ...
   protected boolean isSameCollidablePair (
      CollisionHandler A, CollisionHandler B) {
