...
/**
 * Represents a single AABB that encloses the space-time path of a mesh feature,
 * across a single time step.
 */
public class BoundablePointArray implements Boundable {

   /**
    * Boundary points that comprise the space-time path. AABB will be big enough
    * to enclose all the points.
    *
    * By convention, the first half of the array is comprised of points that
    * represents the mesh feature at the END of the path, while the second half
    * of the array corresponds to the mesh feature at the START of the path.
    */
   ...
   /**
    * Retrieve a transformed point. Transformation matrix used is according to
    * {@link #X}.
    */
   ...
   /**
    * Retrieve all the points with transformation applied. Transformation matrix
    * used is according to {@link #X}.
    */
