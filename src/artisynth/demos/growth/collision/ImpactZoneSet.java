...
public class ImpactZoneSet {
   ...
   /**
    * Remove all the unilateral constraints from the collection of collidable
    * pairs.
    */
   ...
   /**
    * Given a unilateral constraint, get the impact zone that it is binned into.
    */
   ...
   protected boolean isConstraintPairShareCommonVertex (
      ContactConstraint A, ContactConstraint B) {
