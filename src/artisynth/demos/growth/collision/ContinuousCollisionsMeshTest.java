...
public class ContinuousCollisionsMeshTest extends RootModel {
   ...
   protected void build_modelSkeleton () {
      ...
      // mMesh[1] = MeshFactory.createBox (boxSize1, boxSize1, boxSize1, 0, 0,
      // 0);
      // mMesh_prev[1] = MeshFactory.createBox (boxSize1, boxSize1, boxSize1, 0,
      // 0, 0);

      // mMesh[2] = new PolygonalMesh(); mMesh[2].addVertex (10, 0, 0);
      // mMesh_prev[2] = new PolygonalMesh(); mMesh_prev[2].addVertex (10, 5,
      // 0);
   }
   ...
   protected void build_addUI () {
      ...
      // double minDist = mContCol.collideVertexTrianglePnts ( new
      // Point3d(0,0,0), new Point3d(0.51,0,0),
   ...
   public boolean getEnable_broad_edge_collision () {
      return Enable_broad_edge_collision;
   }

   public void setEnable_broad_edge_collision (boolean val) {
      Enable_broad_edge_collision = val;
   }

   protected static boolean Enable_broad_face_collision = false;

   public boolean getEnable_broad_face_collision () {
      return Enable_broad_face_collision;
   }

   public void setEnable_broad_face_collision (boolean val) {
      Enable_broad_face_collision = val;
   }

   protected static boolean Enable_narrow_edge_collision = false;

   public boolean getEnable_narrow_edge_collision () {
      return Enable_narrow_edge_collision;
   }

   public void setEnable_narrow_edge_collision (boolean val) {
      Enable_narrow_edge_collision = val;
   }

   protected static boolean Enable_narrow_face_collision = false;

   public boolean getEnable_narrow_face_collision () {
      return Enable_narrow_face_collision;
   }

   public void setEnable_narrow_face_collision (boolean val) {
      Enable_narrow_face_collision = val;
   }

   protected static boolean[] Show_AABB = new boolean[mNumModels];
   protected static boolean[] Show_sweeps = new boolean[mNumModels];

   public boolean getShow_AABB_0 () {
      return Show_AABB[0];
   }

   public void setShow_AABB_0 (boolean val) {
      Show_AABB[0] = val;
   }

   public boolean getShow_AABB_1 () {
      return Show_AABB[1];
   }

   public void setShow_AABB_1 (boolean val) {
      Show_AABB[1] = val;
   }

   public boolean getShow_AABB_2 () {
      return Show_AABB[2];
   }

   public void setShow_AABB_2 (boolean val) {
      Show_AABB[2] = val;
   }

   public boolean getShow_sweeps_0 () {
      return Show_sweeps[0];
   }

   public void setShow_sweeps_0 (boolean val) {
      Show_sweeps[0] = val;
   }

   public boolean getShow_sweeps_1 () {
      return Show_sweeps[1];
   }

   public void setShow_sweeps_1 (boolean val) {
      Show_sweeps[1] = val;
   }

   public boolean getShow_sweeps_2 () {
      return Show_sweeps[2];
   }

   public void setShow_sweeps_2 (boolean val) {
      Show_sweeps[2] = val;
   }
   ...
   public double getElipson_edge () {
      return Elipson_edge;
   }

   public void setElipson_edge (double val) {
      Elipson_edge = val;
   }

   public double getElipson_face () {
      return Elipson_face;
   }

   public void setElipson_face (double val) {
      Elipson_face = val;
   }

   static {
      myProps
         .add ("Enable_broad_edge_collision", "", Enable_broad_edge_collision);
      myProps
         .add ("Enable_broad_face_collision", "", Enable_broad_face_collision);
      myProps
         .add (
            "Enable_narrow_edge_collision", "", Enable_narrow_edge_collision);
      myProps
         .add (
            "Enable_narrow_face_collision", "", Enable_narrow_face_collision);
   ...
   protected void savePrevPositions (
      RigidBody rb, RigidBody rb_prev, SweptMeshInfo smi) {
      smi.myMesh = rb_prev.getSurfaceMesh ();
      smi.copyCurrent2PreviousPositions ();
      smi.myMesh = rb.getSurfaceMesh ();
   }

   protected void applyTransformsToAABB (
      RigidBody rb, RigidBody rb_prev, SweptMeshInfo smi) {

      Vector3d vec = new Vector3d ();

      // Previous positions must be shifted relative to current RB's local
      // position (i.e. origin).
      ...
      for (int p = 0; p < smi.prevPositions.length; p++) {
         ...
         Point3d ptPrevW =
            new Point3d (rb_prev.getSurfaceMesh ().getVertex (p).pnt);
   ...
   protected void showSweeps (
      RigidBody rb_head, RigidBody rb_tail, Renderer renderer,
      Color lineColor) {
   ...
   public void showIntersectingEdges (Renderer renderer, int m0, int m1) {
      ...
      // mIntersect1.clear ();
      //
      // mSMI[m0].myEdgeTree.intersectTree (mIntersect0, mIntersect1,
      // mSMI[m1].myEdgeTree);
      //
      // renderer.beginDraw (DrawMode.LINES);
      // renderer.setLineWidth (10);
   ...
   public void showIntersectingVertexFaces (Renderer renderer, int vm, int fm) {
      ...
      // mIntersect1.clear ();
      //
      // mSMI[vm].myVertexTree.intersectTree (mIntersect0, mIntersect1,
      // mSMI[fm].myTriangleTree);
      //
      // mPrevIntersectStr = new String( mIntersectStr );
      // mIntersectStr = "";
      ...
      // SweptTriangle st = (SweptTriangle)mIntersect1.get (i).getElements
      // ()[0];
      //
