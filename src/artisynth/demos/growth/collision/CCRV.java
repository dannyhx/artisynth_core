...
public class CCRV {
   /**
    * Time when collision occurred. Between t=0 and t=1. -1 indicates no
    * (imminent) collision.
    */
   ...
   /**
    * Fraction along line segment from tail to head of edge0 where collision
    * occurred.
    */
   public double r;

   /**
    * Fraction along line segment from tail to head of edge1 where collision
    * occurred.
    */
   public double s;
