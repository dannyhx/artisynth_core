 ...
 * 
 * Details can be found in the course notes: "Laplace-Beltrami: The swiss army
 * knife of geometry processing."
 */
      ...
      for (Face face : mMesh.getFaces ()) {
         ...
         do {
            ...
            if (isComputeSparseArea) {
               ...
               if (he.opposite != null)
                  edgeArea += faceAreasBuf[he.getOppositeFace ().idx];
      ...
      for (int chemType : mChemTypesToDiffuse) {
         ...
         for (int v = 0; v < numVtxs; v++) {
            ...
            if (conc < 0) {
               System.out
                  .printf (
                     "diffuse(): Negative concentration detected "
