...
public class GrowNode3d extends FemNode3d {
   ...
   public void setChem2 (double amt) {
      mChems.set (2, amt);
   }

   public double getChem3 () {
      return mChems.get (3);
   }

   public void setChem3 (double amt) {
      mChems.set (3, amt);
   }

   public boolean getIsMorphogenSrc () {
      return mIsMorphogenSrc;
   }

   public void setIsMorphogenSrc (boolean val) {
      mIsMorphogenSrc = val;
   }

   public boolean getIsNoMorphogenZone () {
      return mIsNoMorphogenZone;
   }
   ...
   /**
    * Modified version where normal contribution from each adjacent element is
    * scaled via angle instead of area. This produces a more even result, and is
    * essential when remeshing an asymmetrical mesh into its symmetrical form.
    */
   ...
   public FemNodeNeighbor addIndirectEdgeNeighbor (
      FemNode3d nbrNode, FemEdgeNeighborType neighType) {
