...
public interface GrowElementBase {
    ...
    * 
    * Assuming linear material: F_expected = F_occurred + F_residual where
    * F_expected = The amount of growth to occur. F_occurred = The amount of
    * growth that actually occurred. F_residual = The amount of remaining growth
    * to occur.
    * 
    * @precond Reference configuration is set to the old reference
    * configuration. World configuration is set to the new reference
    * configuration.
    */
   ...
   public static void useResidualPlasticStrain_df (FemElement3dBase _this) {
      ...
      for (int k = 0; k < integPts.length; k++) {
         ...
         integDts[k]
            .computeInverseRestJacobian (integPts[k], _this.getNodes ());
         ...
         if (isExpectedStrainExceed || isResidualStrainExceed
         || isOccurredStrainExceed) {
            System.out
               .printf (
                  "Warning: Linear limit exceed: Exp(%b), "
   ...
   public static GrowStiffnessWarper3d createStiffnessWarper_df (
      FemElement3dBase _this) {
   ...
   public static GrowIntegrationData3d getWarpingData_df (
      FemElement3dBase _this) {
         ...
         if (numPnts == 1) {
            ...
            wdata
               .computeInverseRestJacobian (
                  _this.getWarpingPoint (), _this.getNodes ());
         }
   ...
   public static GrowIntegrationData3d[] doGetIntegrationData_df (
      FemElement3dBase _this) {
   ...
   public static double _computeVolume_df (
      FemElement3dBase _this, boolean isRest) {
      double vol = 0;
